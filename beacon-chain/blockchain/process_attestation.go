...
func (s *Service) onAttestation(ctx context.Context, a *ethpb.Attestation) ([]uint64, error) {
	...
	if featureconfig.Get().UseCheckPointInfoCache {
		...
		s.forkChoiceStore.ProcessAttestation(ctx, indexedAtt.AttestingIndices, bytesutil.ToBytes32(a.Data.BeaconBlockRoot), a.Data.Target.Epoch, bytesutil.ToBytes32(a.Data.ShardHeadRoot), a.Data.Shard)
