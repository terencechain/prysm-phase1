...
func TestProposer_DeleteAttsInPool_Aggregated(t *testing.T) {
	...
	aggregatedAtts := []*ethpb.Attestation{{Data: &ethpb.AttestationData{Slot: 1, BeaconBlockRoot: make([]byte, 32), Target: &ethpb.Checkpoint{Root: make([]byte, 32)}, Source: &ethpb.Checkpoint{Root: make([]byte, 32)}, ShardHeadRoot: make([]byte, 32), ShardTransitionRoot: make([]byte, 32)}, AggregationBits: bitfield.Bitlist{0b10101}, Signature: sig},
		{Data: &ethpb.AttestationData{Slot: 1, BeaconBlockRoot: make([]byte, 32), Target: &ethpb.Checkpoint{Root: make([]byte, 32)}, Source: &ethpb.Checkpoint{Root: make([]byte, 32)}, ShardHeadRoot: make([]byte, 32), ShardTransitionRoot: make([]byte, 32)}, AggregationBits: bitfield.Bitlist{0b11010}, Signature: sig}}
	unaggregatedAtts := []*ethpb.Attestation{{Data: &ethpb.AttestationData{Slot: 1, BeaconBlockRoot: make([]byte, 32), Target: &ethpb.Checkpoint{Root: make([]byte, 32)}, Source: &ethpb.Checkpoint{Root: make([]byte, 32)}, ShardHeadRoot: make([]byte, 32), ShardTransitionRoot: make([]byte, 32)}, AggregationBits: bitfield.Bitlist{0b1001}, Signature: sig},
		{Data: &ethpb.AttestationData{Slot: 1, BeaconBlockRoot: make([]byte, 32), Target: &ethpb.Checkpoint{Root: make([]byte, 32)}, Source: &ethpb.Checkpoint{Root: make([]byte, 32)}, ShardHeadRoot: make([]byte, 32), ShardTransitionRoot: make([]byte, 32)}, AggregationBits: bitfield.Bitlist{0b0001}, Signature: sig}}
